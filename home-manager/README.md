...
- Documents/Pictures/Videos смотрят в `rokokol.home.dataDir`, а волт — в `myWikiDir` из `commonArgs`, одинаковый на обоих хостах: Syncthing везёт симлинки как есть, так что разъехавшиеся пути дали бы битые ссылки на втором хосте
