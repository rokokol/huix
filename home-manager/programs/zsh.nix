...

{
  home.shellAliases = {
    ...
    download-music = "nix run github:nixos/nixpkgs/nixos-unstable#yt-dlp -- --cookies-from-browser firefox -f 'ba' -x --audio-format mp3 --audio-quality 0 --embed-metadata --embed-thumbnail -o '%(title)s.%(ext)s'";
