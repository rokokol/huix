...
| от левого/правого края вбок | соседний воркспейс, тянется за пальцем (встроенный `gestures.workspace_swipe_touch`, полоса `gaps_out` + рамка); хватает 15 % ширины экрана |
