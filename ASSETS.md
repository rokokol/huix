...
It is not my artwork and it is not the greeter cursor — that one is cut from the game's own sprites and lives in [rokokol/ddlc-sddm-theme](https://github.com/rokokol/ddlc-sddm-theme)
