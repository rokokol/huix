...
Имена файлов тут в kebab-case, как и везде в репозитории. На имя семейства это не влияет: оно лежит внутри самого шрифта, и `fontconfig` берёт его оттуда, а `fonts.nix` забирает файлы глобом по расширению
