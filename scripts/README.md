...
| `notify-center.sh` | центр уведомлений поверх mako: режим «не беспокоить», действия/копирование уведомлений, очистка истории, листание ленты в тултипе, JSON-статус для waybar |
...
| `rofi-notify.sh` | лента уведомлений в rofi: действия уведомления, скопировать текст, очистить всё, тумблер DND |
